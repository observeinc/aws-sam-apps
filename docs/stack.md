...
| `EnableMetricTag`                | String             | Enable the metrictag Lambda as a Firehose data transformation that enriches CloudWatch metric stream records with AWS resource tags. Allowed values: `true`, `false`. Default: `false`.                                                                                                              |
