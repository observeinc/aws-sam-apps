...
| `MetricStreamFilterUri` | String | S3 URI containing filters for metrics to be collected by CloudWatch Metrics Stream. If neither this nor DatasourceID is provided, no metrics will be collected. |
...
| `DatasourceID` | Number | The datasource for this metric stream.  |
